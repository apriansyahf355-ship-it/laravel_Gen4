...
<head>
    ...
    <title>Data Supplier | Tugas09_Laravel</title>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item"><a href="/supplier" class="nav-link active"><i class="nav-icon fas fa-truck"></i><p>Supplier</p></a></li>
                </ul>
            </nav>
        </div>
    </aside>
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6"><h1 class="m-0">Data Supplier</h1></div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card card-custom">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-truck mr-2"></i>Daftar Supplier</h3>
                                <div class="card-tools">
                                    <span class="badge badge-danger badge-pill">{{ $suppliers->count() }} Supplier</span>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-hover table-striped mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Email</th>
                                                <th>Alamat</th>
                                                <th width="100" class="text-center">Barang</th>
                                            </tr>
                                        </thead>
                                        <tbody>
