...
<head>
    ...
    <title>Data Satuan | Tugas09_Laravel</title>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item"><a href="/kategori" class="nav-link"><i class="nav-icon fas fa-tags"></i><p>Kategori</p></a></li>
                    <li class="nav-item"><a href="/satuan" class="nav-link active"><i class="nav-icon fas fa-ruler"></i><p>Satuan</p></a></li>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6"><h1 class="m-0">Data Satuan</h1></div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card card-custom">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-ruler mr-2"></i>Daftar Satuan Barang</h3>
                                <div class="card-tools">
                                    <span class="badge badge-danger badge-pill">{{ $satuans->count() }} Satuan</span>
                                </div>
                            </div>
                                ...
                                <table class="table table-hover table-striped mb-0">
                                    <thead>
                                        <tr>
                                            <th width="60">#</th>
                                            <th>Nama Satuan</th>
                                            <th width="160" class="text-center">Singkatan</th>
                                            <th width="160" class="text-center">Jumlah Barang</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><code>{{ $s->singkatan }}</code></td>
                                            <td class="text-center"><span class="badge badge-danger">{{ $s->barangs_count }}</span></td>
                                        </tr>
                                        @empty
